...
<acme:list readonly="false">
	...
	<acme:list-column code="authenticated.task.list.label.initialMoment" path="initialMoment" width="20%"/>
	<acme:list-column code="authenticated.task.list.label.finalMoment" path="finalMoment" width="20%"/>		
