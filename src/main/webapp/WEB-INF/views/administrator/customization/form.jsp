...
<acme:form>
	<acme:form-textbox code="administrator.customization.list.label.name" path="tolerancia"/>	
	
	<acme:form-submit test="${command == 'show'}" code="administrator.spamwords.customization.update" action="/administrator/customization/update"/>
<%-- 	<acme:form-submit test="${command == 'show' }" code="manager.task.form.button.delete" action="/manager/task/delete"/>
	...
	<acme:form-submit test="${command == 'update'}" code="administrator.spamwords.customization.update" action="/administrator/customization/update"/>
