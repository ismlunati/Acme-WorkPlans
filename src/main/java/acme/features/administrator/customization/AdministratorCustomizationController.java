...
public class AdministratorCustomizationController extends AbstractController<Administrator, Customization> {
	...
	@Autowired
	protected AdministratorCustomizationListService listService;
	
	@Autowired
	protected AdministratorCustomizationShowService showService;
	
	@Autowired
	protected AdministratorCustomizationUpdateService updateService;
